...
const BodyPartsRenderer = {
    ...
    'healer': [HEAL, HEAL, HEAL, HEAL, CARRY, CARRY, CARRY, CARRY, MOVE, MOVE, MOVE, MOVE],
    'attacker': [ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE],
